    ...
    return (
       ...
       <Grid container spacing={1}>
            <Grid size={{ xs: 12, md: 6, xl: 3 }}>
                <Item><Component imatge={woods} títol="Woods" textdelparàgraf="Woods es un bosque inmenso y abierto ideal para francotiradores donde destacan el aserradero central y el riesgo constante de pisar minas en sus bordes" textdelprimerbotó="Wiki" enllaçdelprimerbotó="https://escapefromtarkov.fandom.com/wiki/Woods" textdelsegonbotó="Mapa" enllaçdelsegonbotó="https://escapefromtarkov.fandom.com/wiki/Map:Woods?"/></Item>
            </Grid>
            <Grid size={{ xs: 12, md: 6, xl: 3 }}>
                <Item><Component imatge={shore} títol="Shoreline" textdelparàgraf="Shoreline combina una costa extensa con un enorme resort de salud en el centro que concentra todo el botín valioso y los tiroteos intensos en interiores" textdelprimerbotó="Wiki" enllaçdelprimerbotó="https://escapefromtarkov.fandom.com/wiki/Shoreline" textdelsegonbotó="Mapa" enllaçdelsegonbotó="https://escapefromtarkov.fandom.com/wiki/Map:Shoreline?"/></Item>
            </Grid>
            <Grid size={{ xs: 12, md: 6, xl: 3 }}>
                <Item><Component imatge={customs} títol="Customs" textdelparàgraf="Customs es una zona industrial con una carretera central que conecta almacenes y dormitorios siendo el mapa principal para misiones iniciales con combates de media distancia" textdelprimerbotó="Wiki" enllaçdelprimerbotó="https://escapefromtarkov.fandom.com/wiki/Customs" textdelsegonbotó="Mapa" enllaçdelsegonbotó="https://escapefromtarkov.fandom.com/wiki/Map:Customs?"/></Item>
            </Grid>
            <Grid size={{ xs: 12, md: 6, xl: 3 }}>
                <Item><Component imatge={factory} títol="Factory" textdelparàgraf="Factory es un mapa diminuto de una planta química donde la acción es inmediata y frenética centrada totalmente en el combate cercano y partidas muy rápidas" textdelprimerbotó="Wiki" enllaçdelprimerbotó="https://escapefromtarkov.fandom.com/wiki/Factory" textdelsegonbotó="Mapa" enllaçdelsegonbotó="https://escapefromtarkov.fandom.com/wiki/Map:Factory?"/></Item>
            </Grid>
            <Grid size={{ xs: 12, md: 6, xl: 3 }}>
                <Item><Component imatge={labs} títol="Labs" textdelparàgraf="Labs es una instalación subterránea secreta de alta dificultad que requiere tarjeta de acceso para entrar no tiene seguro de equipo y ofrece el botín más caro del juego" textdelprimerbotó="Wiki" enllaçdelprimerbotó="https://escapefromtarkov.fandom.com/wiki/The_Lab" textdelsegonbotó="Mapa" enllaçdelsegonbotó="https://escapefromtarkov.fandom.com/wiki/Map:The_Lab?"/></Item>
            </Grid>
        </Grid>
        </>
    );
